  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-horizontal navbar-expand-md navbar-dark">
      <div class="container px-4">
        <a class="" href="../../">
          <img src="../../img/nabvar.png" height="150px"/>
        </a>
    ...
    <div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          ...
          <div class="row mt-3">
          <div class="col-4">
              <a href="client_signup.php" class=" btn btn-success "><small>Sign Up</small></a>
            </div>

            <div class="col-4">
              <a href="client_pwd_reset.php" class=" btn btn-danger"><small>Forgot Password?</small></a>
            </div>
            
            <div class="col-4 text-right">
              <a href="../../" class="btn btn-primary"><small>Home</small></a>
            </div>
          </div>
        </div>
      </div>
