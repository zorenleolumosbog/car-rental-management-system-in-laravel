				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-12 col-md-6 ">
							<h6 class="text-white ">Itsourcecode Car Rentals Agency.</h6>
							<h1 class="text-white text-uppercase">
								The Royal Essence of Journey
							</h1>
							<p class="pt-20 pb-20 text-white">
									Welcome to Itsourcecode Car Rentals Agency, Search, hire, drive your dream car and travel hassle-free.
							</p>
				...
				<div class="container-fluid">				
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-lg-6 no-padding home-about-right">
							<h1>Itsourcecode Car Rentals Agency<br>
							</h1>
							<p>
							...
							<p>
								...
								Worry no more because here at Itsourcecode Car Rentals Agency we take away that dillemma and let you drive your dream car for a couple of days,
					...
					<div class="row">
						<div class="col-lg-4 col-md-6">
							<div class="single-review">
								...
								<p>
									Our team when its travelling to countryside or around the town we always hire cars from Itsourcecode Rentals Agency and they do not fail us.
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-review">
								...
								<p>
									...
									service vehicle which tends to be insecure, expensive and slow we always head straight for Itsourcecode Car Rentals Agency which is always one call away, and 
						...
						<div class="col-lg-4 col-md-6">
							<div class="single-review">
								...
								<p>
									...
									my instution for any lectures or co curriclular activies i just hire a car of my choice from Itsourcecode Car Rentals Agency and trust me they 
